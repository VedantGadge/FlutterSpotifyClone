  ...
  static List<MusicList> getMusic2() {
    return <MusicList>[
      MusicList(
          ...
          'This is Marshmello. The essential tracks, all in one...','2024',false),
      MusicList(
          'One Direction',
         ...
         ' This is One Direction. The essential tracks, all in one playlist.',
          'This is One Direction. The essential tracks, all in one...','2024',false),
      MusicList(
          'Bruno Mars',
          ...
          'This is Bruno Mars. The essential tracks, all in one...','2024',false),
      MusicList(
          'Juice WRLD',
          ...
          'This is Juice WRLD. The essential tracks, all in one...','2024',false),
    ];
  }
}
